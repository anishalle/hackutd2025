...
import { getUserInitials, getFullName } from "@/lib/profile/data";
    ...
    <div className="relative" ref={menuRef}>
      ...
      >
        ...
        <div className="flex flex-col items-start">
          <span className="text-xs font-semibold text-white">{profile.firstName}</span>
      ...
      {isOpen && (
        <div className="absolute right-0 top-full z-[60] mt-2 w-64 animate-fadeIn overflow-hidden rounded-2xl border border-white/10 bg-[#050b18] shadow-2xl shadow-cyan-500/20 backdrop-blur-xl">
