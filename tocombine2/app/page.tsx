...
const knownTickets = [
  ...
  {
    id: "WO-9825",
    title: "Set permissions for OmniBio",
    severity: "high" as const,
    eta: "Queued",
    details: "Grant storage + GPU slices for burst workloads.",
    parallelGroup: "B",
    source: "email" as const,
  },
  {
    id: "WO-9826",
    title: "Create user accounts for CloudML",
    severity: "medium" as const,
    eta: "Pending approval",
    details: "Setup 5 user accounts with GPU quota allocation.",
    source: "manual" as const,
  },
  {
    id: "WO-9827",
    title: "Deploy containers for TopoSynth",
    severity: "high" as const,
    eta: "Awaiting provisioning",
    details: "Deploy PyTorch training containers across 32-node pod.",
    source: "slack" as const,
  },
  {
    id: "WO-9828",
    title: "Replace GPU in rack P38",
    severity: "medium" as const,
    eta: "RMA received",
    details: "H100 GPU reporting ECC errors, swap with RMA unit.",
    source: "manual" as const,
  },
  {
    id: "WO-9829",
    title: "Install fiber trunk to spine-6",
    severity: "high" as const,
    eta: "Materials ready",
    details: "Run MTP-24 fiber from distribution to spine switch.",
    source: "manual" as const,
  },
  {
    id: "WO-9830",
    title: "Update BMC firmware L2 racks",
    severity: "medium" as const,
    eta: "Scheduled maintenance",
    details: "Security patch for BMC firmware across 12 racks.",
    source: "email" as const,
  },
];
